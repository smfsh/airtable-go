<a href="https://godoc.org/github.com/smfsh/airtable-go" ><img src="http://img.shields.io/badge/godoc-reference-5272B4.svg?style=flat-square" /></a>
...
```
go get github.com/smfsh/airtable-go
```
Import airtable-go into your project:

```go
import "github.com/smfsh/airtable-go"
```
